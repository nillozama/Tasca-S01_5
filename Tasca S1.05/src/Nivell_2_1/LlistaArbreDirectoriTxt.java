...
public class LlistaArbreDirectoriTxt {
	...
	public void imprimirArbreDirectoris(String miRuta, String tabulador, String fileList) throws IOException{
		
		//String fileList="LlistaArchius.txt";
		
        FileWriter fw = new FileWriter(fileList, true);
